...
bag_select = "2021-07-29-17-34-58.bag";

if bag_select == "2021-07-29-17-33-37.bag"
        length_of_t = 16184;
        pos_front_null = 1;
        pos_back_null = 970;
        t_front_null = pos_front_null*2;
        t_back_null = pos_back_null*2;
        desired_pos_front_null = 204;
        desired_pos_back_null = 503;
        c2_desired_Z = ones(desired_pos_back_null-desired_pos_front_null-1 ,1) * 0.36;
elseif  bag_select == "2021-07-29-17-34-58.bag"
        length_of_t = 16184;
        pos_front_null = 1;
        pos_back_null = 970;
        t_front_null = pos_front_null*2;
        t_back_null = pos_back_null*2;
        desired_pos_front_null = 167;
        desired_pos_back_null = 468;
