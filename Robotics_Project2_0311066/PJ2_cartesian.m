...
%A B C 's matrix
A = [0 0 1 -0.3; -1 0 0 0.2; 0 -1 0 0.3; 0 0 0 1];
B = [0 0 1 0.5; 0 1 0 -0.2; -1 0 0 0.6; 0 0 0 1];
C = [-1 0 0 -0.25; 0 0 1 0.2; 0 1 0 -0.3; 0 0 0 1];
...
%%   畫出position velocity acceleration 變化
%把三段的x y z 合起來為XＹＺ
xA(:) = pA(1,4,:);
xB(:) = pAC(1,4,:);
xC(:) = pC(1,4,:);
