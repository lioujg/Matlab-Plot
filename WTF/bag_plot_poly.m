...
if bag_select == "2021-08-10-15-30-28.bag"
        length_of_t = 16184;
        pos_front_null = 1;
        pos_back_null = 970;
...
figure
plot(t_c2_desired,X_fit,'-')
figure
plot(t_c2_desired,Y_fit,'-')

for i = 1:desire_size
    X_sum(1,i) = X_fit(i) - c2_desired_X(i);
    Y_sum(1,i) = Y_fit(i) - c2_desired_Y(i);
end
...
for k=1:numel(scatter_x)
      text(scatter_x(k)-0.5,scatter_y(k)-0.05,['(' num2str(scatter_x(k)) ',' num2str(scatter_y(k)) ')'])
end
