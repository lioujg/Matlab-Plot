...
%find the theta ?Bvelocity of theta ?Bacceleration of theta from A to A' 
...
%find the theta ?Bvelocity of theta ?Bacceleration of theta due to the
%transition method
s=1;
...
%find the theta ?Bvelocity of theta ?Bacceleration of theta to the final
%position C
s=1;
